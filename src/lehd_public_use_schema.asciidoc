...
C,"Counties","Identifies 5-digit FIPS/ANSI code for counties", "U.S. Census Bureau, Population Division; 2020 FIPS Codes for Counties and County Equivalent Entities (https://www.census.gov/library/reference/code-lists/ansi.html#cou[link])"
M,"Metropolitan/Micropolitan (state part)","Identifies 7-digit code constructed from the 2-digit state FIPS code and the 5-digit CBSA code provided by the Census Bureau’s Geography Division", "U.S. Census Bureau, Population Division; Office of Management and Budget, March 2020 delineations (https://www.census.gov/geographies/reference-files/time-series/demo/metro-micro/delineation-files.html[link])"
